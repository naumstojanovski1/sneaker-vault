...
const Sale = () => {
    ...
    const loadProducts = async () => {
        ...
        const saleProducts = data.filter(p => {
            if (p.status !== 'published' || !p.salePrice || !p.price) return false;
    ...
    const filteredProducts = useMemo(() => {
        ...
        return filtered;
    }, [products, selectedBrands, selectedTypes, selectedGenders, priceRange, sortBy]);
        ...
        <div className="pt-20">
            ...
            <div className="max-w-[1440px] mx-auto px-6 md:px-12 py-8">
                <div className="flex items-center gap-2 text-sm text-gray-500 mb-4">
                    ...
                    <span className="text-black font-bold">Sale</span>
                </div>
                ...
                <div className="flex items-center justify-between mb-6">
                    ...
                    >
                        ...
                        Filters {(selectedBrands.length + selectedTypes.length + selectedGenders.length) > 0 && `(${selectedBrands.length + selectedTypes.length + selectedGenders.length})`}
                    </button>
                    <select
                        value={sortBy}
                ...
                {loading ? (
                    ...
                    <div className="text-center py-20">
                        <p className="text-gray-400 uppercase text-sm">No products on sale</p>
                    </div>
                ) : (
                    <>
