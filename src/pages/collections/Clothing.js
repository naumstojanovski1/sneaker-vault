...
const Clothing = () => {
    ...
    const loadProducts = async () => {
        ...
        setProducts(data.filter(p => p.status === 'published' && p.type === 'Clothing'));
        setLoading(false);
    };
    ...
    return (
        <div className="pt-20">
            <SEO title="All Clothing" description="Shop all clothing collection" />
            ...
            <div className="max-w-[1440px] mx-auto px-6 md:px-12 py-8">
                ...
                <h1 className="text-4xl md:text-6xl font-black italic uppercase tracking-tighter mb-2">
                    All <span className="text-red-600">Clothing</span>
                </h1>
